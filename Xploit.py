...
class Xploit(QMainWindow):
    ...
    def create_dns_tools_tab(self):
        ...
        self.tool_select.addItems(["Subdomain Enumeration", "DNS Records", "Reverse DNS"])
    ...
    def start_port_scan(self):
        ...
        try:
            ...
            if not target:
                QMessageBox.warning(self, "Input Error", "Please enter a target IP/hostname")
                return
            
            start_port = self.start_port.value()
            end_port = self.end_port.value()
            if start_port > end_port:
                QMessageBox.warning(self, "Input Error", "Start port must be less than end port")
                return
            ...
            try:
                ...
                self.report_generator.add_scan_data('port_scan', {
                    'target': target,
    ...
    def start_web_scan(self):
        ...
        try:
            ...
            try:
                ...
                self.report_generator.add_scan_data('web_scan', {
                    'url': url,
                    'options': {
                        'xss': check_xss,
                        'sql': check_sql
    ...
    def start_dns_scan(self):
        ...
        try:
            ...
            try:
                ...
                self.report_generator.add_scan_data('dns_scan', {
                    'domain': domain,
                    'tool': tool,
                    'results': results
                })
    ...
    def start_ssl_check(self):
        ...
        try:
            ...
            try:
                ...
                self.report_generator.add_scan_data('ssl_scan', {
                    'host': host,
                    'results': results
                })
    ...
    def start_hidden_port_scan(self):
        ...
        try:
            ...
            try:
                results = self.hidden_port_detector.scan(target)
                self.hidden_results.setText(str(results))
                
             
                self.report_generator.add_scan_data('hidden_port', {
                    'target': target,
                    'scan_type': scan_type,
                    'results': results
                })
    ...
    def start_password_crack(self):
        ...
        try:
            ...
            try:
                ...
                self.report_generator.add_scan_data('password_crack', {
                    'hash_type': hash_type,
                    'wordlist': wordlist,
                    'results': results
                })
    ...
    def launch_exploit(self):
        ...
        try:
            ...
            try:
                ...
                self.report_generator.add_scan_data('exploit', {
                    'target': target,
                    'exploit': exploit,
                    'results': results
                })
