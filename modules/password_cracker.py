...
class PasswordCracker:
    ...
    def brute_force(self, hash_str: str, max_length: int = 4, charset: str = None) -> Dict:
    ...
    def generate_example_wordlist(self, output_path: str) -> bool:
        """
        Generate a small example wordlist for testing.
        
        Args:
            output_path: Path to save the wordlist
